            ...
            <div className="max-w-7xl mx-auto px-8 py-12">
                ...
                <div className="flex justify-between items-start mb-10">
                    ...
                    <button
                        onClick={() =>
                            router.push(
                                `/Dashboard/Assembly/Edit/${assembly._id}`
                            )
                        }
                        className="bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-6 py-4 rounded-2xl font-black flex items-center gap-3"
                    >
