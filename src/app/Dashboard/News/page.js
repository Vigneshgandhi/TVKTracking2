        ...
        <section className="min-h-screen bg-[#0d0d0d] p-10">
            ...
            <div className="flex justify-between items-center mb-10">
                ...
                <button
                    ...
                    className="bg-yellow-400 text-black font-bold px-6 py-4 rounded-2xl"
                >
                    Publish News
                </button>
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <button
                                        onClick={() =>
                                            router.push(
                                                `/Dashboard/News/Edit/${item._id}`
                                            )
                                        }
                                        className="flex-1 bg-yellow-500 text-black py-3 rounded-xl flex justify-center gap-2"
                                    >
